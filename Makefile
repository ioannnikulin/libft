...
OBJS = $(SRCS:.c=.o)
BSRCS = ft_lstadd_back.c ft_lstadd_front.c ft_lstclear.c ft_lstdelone.c ft_lstiter.c ft_lstlast.c ft_lstmap.c ft_lstnew.c ft_lstsize.c
BOBJS = $(BSRCS:.c=.o)
INCLUDES = -I . 
PACK = ar rcs
